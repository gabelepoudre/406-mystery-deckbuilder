...
public class ClayDialogueTrees : MonoBehaviour, IDialogueTreeCollection
{
    ...
    private DialogueTree BuildIntro()
    {
        ...
        "Wait a sec, forget what I just said. I don't feel like telling you where I was."});
        ...
        "I always go to him for advice so maybe he can help you too?", 
        "Then there's the elk secretary. He seems very capable but something about him seems to rub me the wrong way. It might be worth it to check in on him."});
    ...
    {
        NPCNode root = new(new string[] {"Hah..... So uhhh this is a bit embarrassing to say, but I slept through the entire night.", 
        ...
        "I recall walking out of the restaurant, but that's where my memories end.", 
        "Next thing I knew, it was the next morning and I was back at our hideout. It was very strange...."});
    ...
    {
        DialogueTree tree = new(new NPCNode(new string[] {"Where I was is not important. If you must know, I was in Small Pines. Ok, next question."}));
        return tree;
    }
