...
public class MarkDialogueTrees : MonoBehaviour, IDialogueTreeCollection
{
    ...
    private DialogueTree BuildAfterEncounterWin()
    {
         ...
         "After all of their disastrous union policies, they must be desperate for some good press.", "Every year they host a harvest festival, and every year it's outshined by the berry festival.", 
