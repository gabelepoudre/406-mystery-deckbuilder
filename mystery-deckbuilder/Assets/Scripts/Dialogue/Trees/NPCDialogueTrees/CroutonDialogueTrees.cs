...
public class CroutonDialogueTrees : MonoBehaviour, IDialogueTreeCollection
{
    ...
    private DialogueTree BuildIntro()
    {
        ...
        PlayerNode askFreeTime = new(new string[] { "Are there places you like to visit in your off-time Mayor?" });
        PlayerNode askWork = new(new string[] { "What exactly do you do as Mayor of Small Pines?",
        ...
        NPCNode workAnswer = new(new string[] { "Woof?" , "Okay well usually I attend meetings so I can listen to people talk about stuff." ,
            "I also go greet people and listen to them talk about more stuff.", "I also go to the office and listen to Elkie talk about even more stuff... and then I go eat treats and drink milk!" });
    ...
    private DialogueTree BuildDialogeWithAlan()
    {
        ...
        PlayerNode askAlan = new(new string[] { "Mayor Crouton, it's been reported that the Town Hall has been receiving mysterious thick mail for the past week. Tell me what you know about it." });

        NPCNode alanAnswer = new(new string[] { "Huh, what mail? Ohh, the ones Elkie's been getting! Yeah, I know th--uhh... I mean... NOPE we haven't received any mail! Not here Glubby ol' pal." });
        ...
        PlayerNode askAlan3 = new(new string[] { "Tell me Miss Crouton, is the Elk Secretary receiving mysterious mail?"});

        NPCNode alanAnswer3 = new(new string[] { "OKAY fiiiiine, I'll tell. Elkie has been receiving mysterious mail that he won't show me." ,
            "But I don't think they're bad. They're probs just filled with treats! WAIT, or maybe they're LOVE LETTERS OMIGAHD!" });
    ...
    private DialogueTree BuildDialogueWithNina()
    {
        ...
        PlayerNode askNina = new(new string[] { "Mayor Crouton, I've met with you're younger sister Nina. She told me that none of your plans ever get approved.", "Also, she wants to play." });

        NPCNode ninaAnswer = new(new string[] { "YOU MET NINA!? SHE'S GREAT ISN'T SHE! I WANNA PLA--" ,
            "Er... I mean... the rejection of my plans is wholeheartedly reasonable, since I failed to take into account everyone's best interests." });
    ...
    private DialogueTree BuildEncounterWin()
    {
         return new DialogueTree(new NPCNode(new string[] { "OKAY FINE I'll tell, but just it between us 'kay? It's Elkie, he's the one making decisions." ,
             "But please don't hate him detective, Elkie is nice to me! He's got a lotta ideas and is smart! He just has bad people skills."}));
    }
    ...
    public DialogueTree BuildBerryCommotion()
    {
        ...
        NPCNode surprise = new(new string[] {"*Visibly panicked and sweating* Uhhh... please?"}, name:"Crouton");
